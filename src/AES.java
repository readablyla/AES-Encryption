...
public class AES {
	...
	//Galois field matrix used for mixColumns
	private static final int[][] galois =   {{0x02, 0x03, 0x01, 0x01},
        									{0x01, 0x02, 0x03, 0x01},
        									{0x01, 0x01, 0x02, 0x03},
											{0x03, 0x01, 0x01, 0x02}};

	//inverse Galois field matrix used for invMixColumns
	private static final int[][] inverseGalois = {{0x0e, 0x0b, 0x0d, 0x09},
												 {0x09, 0x0e, 0x0b, 0x0d},
												 {0x0d, 0x09, 0x0e, 0x0b},
												 {0x0b, 0x0d, 0x09, 0x0e}};

	// Key Expansion array
	//I'm not sure that we will need this entire array for AES-128? I read something suggesting we could possibly get away with a shorter version?
	...
	//if we end up moving the implementation methods (AESEncrypt/AESDecrypt or whatever we call them) into another class,
	//we will just make getters and setters for all these variables
